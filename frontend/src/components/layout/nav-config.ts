import {
  ...
  Star, AlertTriangle, FileBarChart, Settings, User, Target, ShieldCheck,
} from 'lucide-react'
...
const allNav: Record<string, NavItem> = {
  ...
  ews:        { label: 'EWS',          path: '/ews',        icon: AlertTriangle },
...
export const navByRole: Record<UserRole, NavItem[]> = {
  admin: [
    allNav.dashboard, allNav.ews, allNav.laporan, allNav.admin, allNav.profil,
  ],
  guru: [
